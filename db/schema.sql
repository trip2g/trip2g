...
CREATE TABLE IF NOT EXISTS "note_versions" (
  ...
  created_at datetime not null default current_timestamp, created_by_user_id integer references users(id) on delete set null, created_by_api_key_id integer references api_keys(id) on delete set null,
