...
, started_at datetime, heartbeat_at datetime, tokens_used integer, steps integer, parent_kind text, parent_id integer, trace text, depth_reached integer not null default 0);
