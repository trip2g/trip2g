...
export type AdminDeleteHtmlInjectionMutationMutationVariables = Exact<{
  input: DeleteHtmlInjectionInput;
}>;


export type AdminDeleteHtmlInjectionMutationMutation = { __typename?: 'Mutation', admin: { __typename?: 'AdminMutation', data: { __typename?: 'DeleteHTMLInjectionPayload', deletedId: any } | { __typename?: 'ErrorPayload', message: string } } };
...
export function $trip2g_graphql_request(query: '\n\t\t\t\t\tmutation AdminDeleteHTMLInjectionMutation($input: DeleteHTMLInjectionInput!) {\n\t\t\t\t\t\tadmin {\n\t\t\t\t\t\t\tdata: deleteHTMLInjection(input: $input) {\n\t\t\t\t\t\t\t\t... on DeleteHTMLInjectionPayload {\n\t\t\t\t\t\t\t\t\tdeletedId\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t... on ErrorPayload {\n\t\t\t\t\t\t\t\t\tmessage\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t', variables: AdminDeleteHTMLInjectionMutationMutationVariables): AdminDeleteHTMLInjectionMutationMutation
