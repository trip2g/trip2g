...
export type AdminMutation = {
  ...
  createWebhook: CreateWebhookOrErrorPayload;
  ...
  deleteWebhook: DeleteWebhookOrErrorPayload;
  ...
  regenerateWebhookSecret: RegenerateWebhookSecretOrErrorPayload;
  ...
  updateWebhook: UpdateWebhookOrErrorPayload;
};
...
export type AdminMutationCreateWebhookArgs = {
...
export type AdminMutationDeleteWebhookArgs = {
...
export type AdminMutationRegenerateWebhookSecretArgs = {
...
export type AdminMutationUpdateWebhookArgs = {
...
export type CreateWebhookOrErrorPayload = CreateWebhookPayload | ErrorPayload;
...
export type DeleteWebhookOrErrorPayload = DeleteWebhookPayload | ErrorPayload;
...
export type RegenerateWebhookSecretInput = {
  id: Scalars['Int64']['input'];
};

export type RegenerateWebhookSecretOrErrorPayload = ErrorPayload | RegenerateWebhookSecretPayload;

export type RegenerateWebhookSecretPayload = {
  __typename?: 'RegenerateWebhookSecretPayload';
  secret: Scalars['String']['output'];
  webhook: AdminChangeWebhook;
};
...
export type UpdateWebhookOrErrorPayload = ErrorPayload | UpdateWebhookPayload;
...
export type AdminCreateWebhookMutationMutationVariables = Exact<{
  input: CreateWebhookInput;
}>;


export type AdminCreateWebhookMutationMutation = { __typename?: 'Mutation', admin: { __typename?: 'AdminMutation', payload: { __typename: 'CreateWebhookPayload', secret: string, webhook: { __typename?: 'AdminChangeWebhook', id: any } } | { __typename: 'ErrorPayload', message: string } } };
...
export type AdminGetChangeWebhookQuery = { __typename?: 'Query', admin: { __typename?: 'AdminQuery', allChangeWebhooks: { __typename?: 'AdminChangeWebhooksConnection', nodes: Array<{ __typename?: 'AdminChangeWebhook', id: any, url: string, enabled: boolean, description: string, instruction: string, hasSecret: boolean, passApiKey: boolean, includeContent: boolean, maxDepth: any, timeoutSeconds: any, maxRetries: any, onCreate: boolean, onUpdate: boolean, onRemove: boolean, includePatterns: Array<string>, excludePatterns: Array<string>, readPatterns: Array<string>, writePatterns: Array<string>, createdAt: any }> } } };

export type AdminDeleteWebhookMutationMutationVariables = Exact<{
  input: DeleteWebhookInput;
}>;


export type AdminDeleteWebhookMutationMutation = { __typename?: 'Mutation', admin: { __typename?: 'AdminMutation', payload: { __typename: 'DeleteWebhookPayload', deletedId: any } | { __typename: 'ErrorPayload', message: string } } };

export type AdminRegenerateWebhookSecretMutationMutationVariables = Exact<{
  input: RegenerateWebhookSecretInput;
}>;


export type AdminRegenerateWebhookSecretMutationMutation = { __typename?: 'Mutation', admin: { __typename?: 'AdminMutation', payload: { __typename: 'ErrorPayload', message: string } | { __typename: 'RegenerateWebhookSecretPayload', secret: string } } };
...
export type AdminShowChangeWebhookForUpdateQuery = { __typename?: 'Query', admin: { __typename?: 'AdminQuery', allChangeWebhooks: { __typename?: 'AdminChangeWebhooksConnection', nodes: Array<{ __typename?: 'AdminChangeWebhook', id: any, url: string, enabled: boolean, description: string, instruction: string, includePatterns: Array<string>, excludePatterns: Array<string>, passApiKey: boolean, includeContent: boolean, maxDepth: any, timeoutSeconds: any, maxRetries: any, onCreate: boolean, onUpdate: boolean, onRemove: boolean, readPatterns: Array<string>, writePatterns: Array<string> }> } } };

export type AdminUpdateWebhookMutationMutationVariables = Exact<{
  input: UpdateWebhookInput;
}>;


export type AdminUpdateWebhookMutationMutation = { __typename?: 'Mutation', admin: { __typename?: 'AdminMutation', payload: { __typename: 'ErrorPayload', message: string } | { __typename: 'UpdateWebhookPayload', webhook: { __typename?: 'AdminChangeWebhook', id: any } } } };
...
export type AdminGetCronWebhookQuery = { __typename?: 'Query', admin: { __typename?: 'AdminQuery', allCronWebhooks: { __typename?: 'AdminCronWebhooksConnection', nodes: Array<{ __typename?: 'AdminCronWebhook', id: any, url: string, cronSchedule: string, enabled: boolean, description: string, instruction: string, hasSecret: boolean, passApiKey: boolean, maxDepth: any, timeoutSeconds: any, maxRetries: any, readPatterns: Array<string>, writePatterns: Array<string>, nextRunAt?: any | null, createdAt: any }> } } };
...
export type AdminShowCronWebhookForUpdateQuery = { __typename?: 'Query', admin: { __typename?: 'AdminQuery', allCronWebhooks: { __typename?: 'AdminCronWebhooksConnection', nodes: Array<{ __typename?: 'AdminCronWebhook', id: any, url: string, cronSchedule: string, enabled: boolean, description: string, instruction: string, passApiKey: boolean, maxDepth: any, timeoutSeconds: any, maxRetries: any, readPatterns: Array<string>, writePatterns: Array<string> }> } } };
...
export type $trip2g_graphql_AdminCreateWebhookMutationVariables = AdminCreateWebhookMutationMutationVariables
...
export type $trip2g_graphql_AdminDeleteWebhookMutationVariables = AdminDeleteWebhookMutationMutationVariables

export type $trip2g_graphql_AdminRegenerateWebhookSecretMutationVariables = AdminRegenerateWebhookSecretMutationMutationVariables

export type $trip2g_graphql_AdminShowChangeWebhookForUpdateVariables = AdminShowChangeWebhookForUpdateQueryVariables

export type $trip2g_graphql_AdminUpdateWebhookMutationVariables = AdminUpdateWebhookMutationMutationVariables
