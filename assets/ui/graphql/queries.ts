...
export type AdminQuery = {
  ...
  allTelegramCustomEmojies: AdminTelegramCustomEmojiConnection;
...
export type AdminTelegramCustomEmojiConnection = {
  __typename?: 'AdminTelegramCustomEmojiConnection';
  nodes: Array<TelegramCustomEmoji>;
};
...
export type Query = {
  ...
  /** X-Api-Key header must be set. */
  telegramCustomEmojies: Array<TelegramCustomEmoji>;
  viewer: Viewer;
};
...
export type QueryTelegramCustomEmojiesArgs = {
  filter: TelegramCustomEmojiesFilter;
};
...
export type TelegramCustomEmoji = {
  __typename?: 'TelegramCustomEmoji';
  base64Uri: Scalars['String']['output'];
  id: Scalars['String']['output'];
};

export type TelegramCustomEmojiesFilter = {
  botId?: InputMaybe<Scalars['Int64']['input']>;
...
export type AdminListTelegramCustomEmojiesQueryVariables = Exact<{ [key: string]: never; }>;


export type AdminListTelegramCustomEmojiesQuery = { __typename?: 'Query', admin: { __typename?: 'AdminQuery', allTelegramCustomEmojies: { __typename?: 'AdminTelegramCustomEmojiConnection', nodes: Array<{ __typename?: 'TelegramCustomEmoji', id: string, base64Uri: string }> } } };
