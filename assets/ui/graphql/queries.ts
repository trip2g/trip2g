...
export type AdminQuery = {
  ...
  telegramAccountChats: AdminTelegramAccountChatsConnection;
...
export type AdminQueryTelegramAccountChatsArgs = {
  filter: AdminTelegramAccountChatsFilterInput;
};
...
export type AdminTelegramAccountChat = {
  __typename?: 'AdminTelegramAccountChat';
...
export type AdminTelegramAccountChatsConnection = {
  __typename?: 'AdminTelegramAccountChatsConnection';
  nodes: Array<AdminTelegramAccountChat>;
};

export type AdminTelegramAccountChatsFilterInput = {
  accountId: Scalars['Int64']['input'];
};
