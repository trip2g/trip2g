...
export type AdminMutation = {
  ...
  updateNoteGraphPosition: UpdateNoteGraphPositionOrErrorPayload;
...
export type AdminMutationUpdateNoteGraphPositionArgs = {
...
export type UpdateNoteGraphPositionOrErrorPayload = ErrorPayload | UpdateNoteGraphPositionPayload;

export type UpdateNoteGraphPositionPayload = {
  __typename?: 'UpdateNoteGraphPositionPayload';
  noteView: NoteView;
  success: Scalars['Boolean']['output'];
};
...
export type AdminGraphQuery = { __typename?: 'Query', admin: { __typename?: 'AdminQuery', allSubgraphs: { __typename?: 'AdminSubgraphsConnection', nodes: Array<{ __typename?: 'AdminSubgraph', name: string, color?: string | null }> }, allLatestNoteViews: { __typename?: 'AdminLatestNoteViewsConnection', nodes: Array<{ __typename?: 'NoteView', id: string, subgraphNames: Array<string>, pathId: any, graphPosition?: { __typename?: 'Vector2', x: number, y: number } | null, inLinks: Array<{ __typename?: 'NoteView', title: string, pathId: any, id: string }> }> } } };

export type AdminUpdateNoteGraphPositionMutationVariables = Exact<{
  input: UpdateNoteGraphPositionInput;
}>;


export type AdminUpdateNoteGraphPositionMutation = { __typename?: 'Mutation', admin: { __typename?: 'AdminMutation', data: { __typename?: 'ErrorPayload', message: string } | { __typename?: 'UpdateNoteGraphPositionPayload', success: boolean } } };
