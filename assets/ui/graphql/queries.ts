...
export type AdminGraphQuery = { __typename?: 'Query', admin: { __typename?: 'AdminQuery', allSubgraphs: { __typename?: 'AdminSubgraphsConnection', nodes: Array<{ __typename?: 'AdminSubgraph', name: string, color?: string | null }> }, allLatestNoteViews: { __typename?: 'AdminLatestNoteViewsConnection', nodes: Array<{ __typename?: 'NoteView', id: string, subgraphNames: Array<string>, title: string, pathId: any, free: boolean, isHomePage: boolean, meta: Array<{ __typename?: 'NoteViewMeta', key: string, raw: string }>, graphPosition?: { __typename?: 'Vector2', x: number, y: number } | null, inLinks: Array<{ __typename?: 'NoteView', title: string, pathId: any, id: string }> }> } } };
...
export type EditorPushNotesMutation = { __typename?: 'Mutation', pushNotes: { __typename: 'ErrorPayload', message: string } | { __typename: 'PushNotesPayload', updated: Array<{ __typename?: 'PushedNote', path: string, url?: string | null, id: any }> } };

export type EditorCreateNoteMutationVariables = Exact<{
  input: UpdateNotesInput;
}>;


export type EditorCreateNoteMutation = { __typename?: 'Mutation', updateNotes: { __typename: 'ErrorPayload', message: string } | { __typename: 'UpdateNotesHashMismatchPayload', path: string, actualHash: string } | { __typename: 'UpdateNotesPatchNotFoundPayload' } | { __typename: 'UpdateNotesSuccessPayload', paths: Array<string> } };
...
export type EditorExternalVersionQueryVariables = Exact<{
  versionId: Scalars['Int64']['input'];
}>;


export type EditorExternalVersionQuery = { __typename?: 'Query', admin: { __typename?: 'AdminQuery', noteVersion?: { __typename?: 'AdminNoteVersionDetail', content: string } | null } };
...
export type NoteTaskListQueryVariables = Exact<{
  input: NoteInput;
}>;


export type NoteTaskListQuery = { __typename?: 'Query', viewer: { __typename?: 'Viewer', role: Role }, note?: { __typename?: 'PublicNote', versionId: any, taskList: Array<{ __typename?: 'NoteTaskItem', index: number, line: number, checked: boolean, text: string }> } | null };

export type TaskListNoteContentQueryVariables = Exact<{
  filter?: InputMaybe<NotePathsFilter>;
}>;


export type TaskListNoteContentQuery = { __typename?: 'Query', notePaths: Array<{ __typename?: 'NotePath', id: any, content: string, latestContentHash: string, latestNoteView?: { __typename?: 'NoteView', versionId: any } | null }> };

export type TaskListToggleMutationVariables = Exact<{
  input: UpdateNotesInput;
}>;


export type TaskListToggleMutation = { __typename?: 'Mutation', updateNotes: { __typename: 'ErrorPayload', message: string } | { __typename: 'UpdateNotesHashMismatchPayload', path: string, actualHash: string } | { __typename: 'UpdateNotesPatchNotFoundPayload', path: string, find: string } | { __typename: 'UpdateNotesSuccessPayload', updated: Array<{ __typename?: 'NoteWriteResult', path: string, versionId: any }> } };

// This file is auto-generated by graphqlmol.js

// Do not edit manually - run `npm run graphqlgen` to regenerate



export function $trip2g_graphql_request(query: '\n\t\tquery Admins {\n\t\t\tadmin {\n\t\t\t\tallAdmins {\n\t\t\t\t\tnodes {\n\t\t\t\t\t\tid\n\t\t\t\t\t\tgrantedAt\n\t\t\t\t\t\tuser {\n\t\t\t\t\t\t\temail\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t'): () => AdminsQuery

export function $trip2g_graphql_request(query: '\n\t\tmutation AdminCreateAdmin($input: CreateAdminInput!) {\n\t\t\tadmin {\n\t\t\t\tdata: createAdmin(input: $input) {\n\t\t\t\t\t__typename\n\t\t\t\t\t... on ErrorPayload {\n\t\t\t\t\t\tmessage\n\t\t\t\t\t}\n\t\t\t\t\t... on CreateAdminPayload {\n\t\t\t\t\t\tadmin {\n\t\t\t\t\t\t\tid\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t'): (variables: AdminCreateAdminMutationVariables) => AdminCreateAdminMutation
...
export function $trip2g_graphql_request(query: '\n\t\tquery AdminSecretKeys($filter: SecretKeysFilter) {\n\t\t\tadmin {\n\t\t\t\tsecretKeys(filter: $filter)\n\t\t\t}\n\t\t}\n\t'): (variables: AdminSecretKeysQueryVariables) => AdminSecretKeysQuery

export function $trip2g_graphql_request(query: '\n\t\tmutation AdminSetSecret($input: SetSecretInput!) {\n\t\t\tadmin {\n\t\t\t\tsetSecret(input: $input) {\n\t\t\t\t\tkey\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t'): (variables: AdminSetSecretMutationVariables) => AdminSetSecretMutation

export function $trip2g_graphql_request(query: '\n\t\tmutation AdminDeleteSecret($id: String!) {\n\t\t\tadmin {\n\t\t\t\tdeleteSecret(id: $id) {\n\t\t\t\t\tid\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t'): (variables: AdminDeleteSecretMutationVariables) => AdminDeleteSecretMutation
...
export function $trip2g_graphql_request(query: '\n\t\tquery EditorExternalVersion($versionId: Int64!) {\n\t\t\tadmin {\n\t\t\t\tnoteVersion(versionId: $versionId) {\n\t\t\t\t\tcontent\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t'): (variables: EditorExternalVersionQueryVariables) => EditorExternalVersionQuery

export function $trip2g_graphql_request(query: '\n\t\tquery EditorNoteVersions($filter: AdminNoteVersionHistoryFilter!) {\n\t\t\tadmin {\n\t\t\t\tnoteVersionHistory(filter: $filter) {\n\t\t\t\t\tnodes {\n\t\t\t\t\t\tversionId\n\t\t\t\t\t\tversion\n\t\t\t\t\t\tcontentLength\n\t\t\t\t\t\tcreatedAt\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t'): (variables: EditorNoteVersionsQueryVariables) => EditorNoteVersionsQuery

export function $trip2g_graphql_request(query: '\n\t\tquery EditorNoteVersion($versionId: Int64!) {\n\t\t\tadmin {\n\t\t\t\tnoteVersion(versionId: $versionId) {\n\t\t\t\t\tversionId\n\t\t\t\t\tcontent\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t'): (variables: EditorNoteVersionQueryVariables) => EditorNoteVersionQuery
...
export const $trip2g_graphql_note_change_type = NoteChangeType;
...
export const $trip2g_graphql_search_match_origin = SearchMatchOrigin;

export const $trip2g_graphql_storage_size_format = StorageSizeFormat;
...
export type $trip2g_graphql_AdminCreateAdminVariables = AdminCreateAdminMutationVariables

export type $trip2g_graphql_DisableApiKeyVariables = DisableApiKeyMutationVariables

export type $trip2g_graphql_EnableApiKeyVariables = EnableApiKeyMutationVariables

export type $trip2g_graphql_SetApiKeyMcpAdminToolsVariables = SetApiKeyMcpAdminToolsMutationVariables
...
export type $trip2g_graphql_AdminChangeWebhookCreateMutationVariables = AdminChangeWebhookCreateMutationMutationVariables

export type $trip2g_graphql_AdminShowChangeWebhookVariables = AdminShowChangeWebhookQueryVariables

export type $trip2g_graphql_AdminGetChangeWebhookVariables = AdminGetChangeWebhookQueryVariables

export type $trip2g_graphql_AdminChangeWebhookDeleteMutationVariables = AdminChangeWebhookDeleteMutationMutationVariables

export type $trip2g_graphql_AdminChangeWebhookRegenerateSecretMutationVariables = AdminChangeWebhookRegenerateSecretMutationMutationVariables

export type $trip2g_graphql_TriggerChangeWebhookVariables = TriggerChangeWebhookMutationVariables

export type $trip2g_graphql_AdminShowChangeWebhookForUpdateVariables = AdminShowChangeWebhookForUpdateQueryVariables

export type $trip2g_graphql_AdminChangeWebhookUpdateMutationVariables = AdminChangeWebhookUpdateMutationMutationVariables

export type $trip2g_graphql_AdminConfigValueVariables = AdminConfigValueQueryVariables

export type $trip2g_graphql_AdminSetConfigStringValueVariables = AdminSetConfigStringValueMutationVariables

export type $trip2g_graphql_AdminSetConfigBoolValueVariables = AdminSetConfigBoolValueMutationVariables

export type $trip2g_graphql_AdminSetConfigIntValueVariables = AdminSetConfigIntValueMutationVariables
...
export type $trip2g_graphql_AdminCreateCronWebhookMutationVariables = AdminCreateCronWebhookMutationMutationVariables

export type $trip2g_graphql_AdminCronWebhookDeliveriesVariables = AdminCronWebhookDeliveriesQueryVariables

export type $trip2g_graphql_AdminGetCronWebhookVariables = AdminGetCronWebhookQueryVariables

export type $trip2g_graphql_AdminDeleteCronWebhookMutationVariables = AdminDeleteCronWebhookMutationMutationVariables

export type $trip2g_graphql_AdminRegenerateCronWebhookSecretMutationVariables = AdminRegenerateCronWebhookSecretMutationMutationVariables

export type $trip2g_graphql_AdminTriggerCronWebhookMutationVariables = AdminTriggerCronWebhookMutationMutationVariables
...
export type $trip2g_graphql_AdminRevokeFederationSecretVariables = AdminRevokeFederationSecretMutationVariables

export type $trip2g_graphql_AdminCreateInboundFederationSecretVariables = AdminCreateInboundFederationSecretMutationVariables

export type $trip2g_graphql_AdminCreateOutboundFederationSecretVariables = AdminCreateOutboundFederationSecretMutationVariables

export type $trip2g_graphql_AdminAddFederationSecretSubgraphVariables = AdminAddFederationSecretSubgraphMutationVariables

export type $trip2g_graphql_AdminRemoveFederationSecretSubgraphVariables = AdminRemoveFederationSecretSubgraphMutationVariables

export type $trip2g_graphql_AdminFormSubmitsVariables = AdminFormSubmitsQueryVariables
...
export type $trip2g_graphql_GitHubOAuthUrlsVariables = GitHubOAuthUrlsQueryVariables

export type $trip2g_graphql_AdminCreateGitHubOAuthCredentialsVariables = AdminCreateGitHubOAuthCredentialsMutationVariables

export type $trip2g_graphql_AdminDeleteGitHubOAuthCredentialsVariables = AdminDeleteGitHubOAuthCredentialsMutationVariables

export type $trip2g_graphql_AdminGitHubOAuthCredentialsByIdVariables = AdminGitHubOAuthCredentialsByIdQueryVariables

export type $trip2g_graphql_AdminSetActiveGitHubOAuthCredentialsVariables = AdminSetActiveGitHubOAuthCredentialsMutationVariables

export type $trip2g_graphql_GoogleOAuthUrlsVariables = GoogleOAuthUrlsQueryVariables

export type $trip2g_graphql_AdminCreateGoogleOAuthCredentialsVariables = AdminCreateGoogleOAuthCredentialsMutationVariables

export type $trip2g_graphql_AdminDeleteGoogleOAuthCredentialsVariables = AdminDeleteGoogleOAuthCredentialsMutationVariables

export type $trip2g_graphql_AdminGoogleOAuthCredentialsByIdVariables = AdminGoogleOAuthCredentialsByIdQueryVariables

export type $trip2g_graphql_AdminSetActiveGoogleOAuthCredentialsVariables = AdminSetActiveGoogleOAuthCredentialsMutationVariables
...
export type $trip2g_graphql_AdminSecretKeysVariables = AdminSecretKeysQueryVariables

export type $trip2g_graphql_AdminSetSecretVariables = AdminSetSecretMutationVariables

export type $trip2g_graphql_AdminDeleteSecretVariables = AdminDeleteSecretMutationVariables
...
export type $trip2g_graphql_AdminCreateUserSubgraphAccessVariables = AdminCreateUserSubgraphAccessMutationVariables
...
export type $trip2g_graphql_OAuthUrlsVariables = OAuthUrlsQueryVariables

export type $trip2g_graphql_EditorNoteVersionDiffVariables = EditorNoteVersionDiffQueryVariables

export type $trip2g_graphql_EditorNoteContentVariables = EditorNoteContentQueryVariables

export type $trip2g_graphql_EditorPushNotesVariables = EditorPushNotesMutationVariables

export type $trip2g_graphql_EditorCreateNoteVariables = EditorCreateNoteMutationVariables

export type $trip2g_graphql_ResolveWikilinksVariables = ResolveWikilinksQueryVariables

export type $trip2g_graphql_EditorNoteVersionsForDiffVariables = EditorNoteVersionsForDiffQueryVariables

export type $trip2g_graphql_EditorExternalVersionVariables = EditorExternalVersionQueryVariables
...
export type $trip2g_graphql_CurrentTimeVariables = CurrentTimeSubscriptionVariables
...
export type $trip2g_graphql_CreateUserTokenVariables = CreateUserTokenMutationVariables

export type $trip2g_graphql_RevokeUserTokenVariables = RevokeUserTokenMutationVariables

export type $trip2g_graphql_NoteTaskListVariables = NoteTaskListQueryVariables

export type $trip2g_graphql_TaskListNoteContentVariables = TaskListNoteContentQueryVariables

export type $trip2g_graphql_TaskListToggleVariables = TaskListToggleMutationVariables
