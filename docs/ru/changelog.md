...
- **Зачем.** Вебхуки часто должны аутентифицироваться во внешних сервисах. Хранить токены в URL или инструкциях небезопасно. Секреты шифруются при хранении и не попадают в логи или историю доставок.
