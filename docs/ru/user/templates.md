...
> **Пример вживую:** [[instaframes/_index|Instagram-фреймы]] — готовый шаблон, который собирает из markdown-файла скачиваемые карусели и рилсы для соцсетей. Наглядно, как кастомный layout делает реальную работу.
