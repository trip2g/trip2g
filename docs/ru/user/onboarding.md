...
По умолчанию контент публикуется через [[releases|релизы]]. Пока вы тестируете сервис, удобнее видеть изменения сразу. Включите показ черновиков — ваши заметки будут видны сразу после синхронизации.
