...
- **8 заметок звонков** — выведенное название, сильный первый абзац, ссылка на сырой транскрипт и разбор, где у каждой темы однострочная выжимка, а под ней дословная цитата из транскрипта со ссылкой-таймрейнджем;
- **220 заметок-концептов**: люди, инструменты, проекты, термины — у каждой алиасы и упоминания, которые цитируют тот самый сегмент, где термин всплыл;
