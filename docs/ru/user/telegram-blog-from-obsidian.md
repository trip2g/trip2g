...
Чтобы опубликовать сразу, а не по расписанию, используйте мгновенный тег (см. [[ru/user/telegram-instant|предпросмотр в тестовом канале]]). Отдельный тестовый канал с мгновенным тегом — самый безопасный способ проверить пост до основной аудитории.
