...
При открытии этой ссылки режим следования включается в этой вкладке. Настройка сохраняется в локальном хранилище и переживает автоматические переходы. Чтобы отключить — перезагрузите страницу без флага и выключите через панель инструментов.
