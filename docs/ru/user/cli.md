...
Подробнее о сценариях использования — [[docs-from-repo|в статье про документацию из репозитория]].
...
Подробнее о настройке CI/CD — [[docs-from-repo|в статье про документацию из репозитория]].
