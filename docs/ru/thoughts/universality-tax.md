...
```datachart
{
  "data": {
    "source": "inline",
    "rows": [
      { "subsystem": "Движок layout'ов", "changes": 2 },
      { "subsystem": "Сохранение и версии", "changes": 2 },
      { "subsystem": "Семантика синхронизации", "changes": 3 },
      { "subsystem": "CLI и установка", "changes": 2 }
    ]
  },
  "config": {
    "xAxis": { "type": "category" },
