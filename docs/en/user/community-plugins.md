...
See the [official security documentation](https://help.obsidian.md/Extending+Obsidian/Plugin+security) for details.
...
3. Click **Turn on community plugins** (if a security prompt appears)
4. Click **Browse**
5. Search by name, author, or description

**In the browser:** visit [obsidian.md/plugins](https://obsidian.md/plugins) — the full catalog with descriptions and screenshots.
...
1. Settings → **Community plugins** → **Current plugins**
2. Click **Check for updates**
3. Click **Update all** if updates are available, or **Update** next to a specific plugin
