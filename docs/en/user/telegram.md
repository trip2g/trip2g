...
Give a private test channel an Instant Tag and a note carrying that tag arrives there the moment you sync it, so you see the finished post before your readers do. See [[en/user/telegram-instant]].
