...
# The expected-CRITICAL allowlist and the CLI wrapper are shared with test-e2e.sh.
SYNC_CLI_ENTRY="$OBSIDIAN_SYNC_DIR/src/sync/cli/cmd.ts"
source "$PROJECT_ROOT/scripts/lib/sync-cli.sh"
