...
func NewHTTPHandler(auth func(http.Handler) http.Handler) http.Handler {
	srv := handler.New(codellmgen.NewExecutableSchema(codellmgen.Config{Resolvers: NewResolver()}))
