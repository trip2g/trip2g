...
Some content here.`,
			expectedHeadings: NoteViewHeadings{
				{Text: "Main Title", Level: 1, ID: "main_title"},
			},
		},
		{
...
Final content.`,
			expectedHeadings: NoteViewHeadings{
				{Text: "Chapter 1", Level: 1, ID: "chapter_1"},
				{Text: "Section 1.1", Level: 2, ID: "section_1_1"},
				{Text: "Subsection 1.1.1", Level: 3, ID: "subsection_1_1_1"},
				{Text: "Section 1.2", Level: 2, ID: "section_1_2"},
			},
		},
		{
...
### [Link](http://example.com) Heading`,
			expectedHeadings: NoteViewHeadings{
				{Text: "Bold Heading", Level: 1, ID: "bold_heading"},
				{Text: "Italic Heading", Level: 2, ID: "italic_heading"},
				{Text: "Link Heading", Level: 3, ID: "link_heading"},
			},
		},
		{
...
###### Sixth Level`,
			expectedHeadings: NoteViewHeadings{
				{Text: "Second Level", Level: 1, ID: "second_level"},
				{Text: "Fourth Level", Level: 2, ID: "fourth_level"},
				{Text: "Sixth Level", Level: 3, ID: "sixth_level"},
			},
		},
	}
