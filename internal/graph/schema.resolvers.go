...
// DeliveryLogs is the resolver for the deliveryLogs field.
func (r *adminQueryResolver) DeliveryLogs(ctx context.Context, obj *appmodel.AdminQuery, kind string, deliveryID int64) ([]model.AdminDeliveryLog, error) {
