package deletefrontmatterpatch
...
type Input = model.DeleteFrontmatterPatchInput

// Payload is an alias for the GraphQL payload type.
type Payload = model.DeleteFrontmatterPatchOrErrorPayload
...
// Resolve deletes a frontmatter patch.
func Resolve(ctx context.Context, env Env, input Input) (Payload, error) {
	...
	payload := model.DeleteFrontmatterPatchPayload{
		DeletedID: input.ID,
	}
