...
type Input = model.StartBackgroundQueueInput
type Payload = model.StartBackgroundQueueOrErrorPayload
...
func Resolve(ctx context.Context, env Env, input Input) (Payload, error) {
	...
	err = env.StartBackgroundQueue(ctx, input.ID)
	if err != nil {
	...
	payload := model.StartBackgroundQueuePayload{
		Queues: queues,
	}
